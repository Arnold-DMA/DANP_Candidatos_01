...
object Distritos {
    ...
    val distritos: List<Distrito> = listOf(
        Distrito("ALTO SELVA ALEGRA", "2500", "86174", "6.98", "Aquí va la  descripción del distrito  de Alto Selva Alegre", "17", R.drawable.ic_alto_selva_alegre),
        Distrito("CAYMA", "2403", "96009", "246.31", "Aquí va la  descripción del distrito  de Cayma", "16", R.drawable.ic_cayma)
    )
}